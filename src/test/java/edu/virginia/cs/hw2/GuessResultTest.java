...
class GuessResultTest {
    ...
    @Test
    @DisplayName("Incorrect answer Guess Result Test")
    public void testLetterResultAllGrayAnswer() {
        givenInputGuessAndAnswer("WORLD", "MATCH");
    ...
    @Test
    @DisplayName("Incorrect answer Guess Result Test")
    public void testLetterResultOneGreenAnswer() {
        givenInputGuessAndAnswer("MOUSE", "MATCH");
    ...
    @Test
    @DisplayName("Incorrect answer Guess Result Test")
    public void testLetterResultOneYellowAnswer() {
        givenInputGuessAndAnswer("SMILE", "MATCH");
    ...
    @Test
    @DisplayName("Incorrect answer Guess Result Test")
    public void testLetterResultTwoGreenOneYellowAnswer() {
        givenInputGuessAndAnswer("MOUTH", "MATCH");
    ...
    @Test
    @DisplayName("Incorrect duplicate answer Guess Result Test")
    public void testLetterResultDuplicateLettersAnswer() {
        givenInputGuessAndAnswer("MOOSE", "MOUTH");
    ...
    @Test
    @DisplayName("Incorrect duplicate answer Guess Result Test")
    public void testLetterResultAnotherDuplicateLettersAnswer() {
        givenInputGuessAndAnswer("FOOTS", "SPOON");
